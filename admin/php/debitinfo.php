<?php
    ...
    if ($option == "debit") {
        if (isset($_SESSION['email'])) {
            ...
            $sql = "INSERT INTO orders_table (cust_name, address, phone, email, cart, quantity) VALUES (CONCAT('$firstname', ' ', '$lastname'), CONCAT('$streetopt',', ','$street',', ','$town',', ','$city',', ','$zip'), '$phone', '$email', '$cart', '$quantity')";
            // injecting sql query
        ...
        if (isset($_SESSION['email'])) {
            ...
            // insert data to orders_table
            $sql = "INSERT INTO orders_table (cust_name, address, phone, email, cart, quantity, status) VALUES (CONCAT('$firstname', ' ', '$lastname'), CONCAT('$streetopt',', ','$street',', ','$town',', ','$city',', ','$zip'), '$phone', '$email', '$cart', '$quantity', 'Cash on Delivery')";
            // injecting sql query
            $result = $con->query($sql);
             // variable initialization
            $newCart ="";
