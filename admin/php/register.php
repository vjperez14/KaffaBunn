<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['email_check']) && $_POST['email_check'] == 1) {
        ...
        // insert into table
        $sql = "INSERT INTO registered_accounts (firstname, lastname, email, password, city, street, streetopt, town, zip, phone) VALUES ('$fname', '$lname', '$email', '$password', '$city', '$street', '$streetopt', '$town', '$zip', '$phone') ";
