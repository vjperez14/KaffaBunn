        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="images/drink7.jpg" class="image-popup"><img src="images/drink7.jpg" class="img-fluid"
                            alt="Colorlib Template"></a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    <h1 style="font-family: Lobster; " id="prodName">Café Americano</h3>
                        <p class="price" style="margin-top: -3%;"><span style=" font-size: 20px;">₱125.00</span></p>
