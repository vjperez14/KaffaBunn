        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="images/food11.jpg" class="image-popup"><img src="images/food11.jpg" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    <h1 style="font-family: Lobster; " id="prodName">Asian Chicken Salad</h3>
