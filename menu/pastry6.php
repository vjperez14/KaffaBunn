        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="images/pastry6.jpg" class="image-popup"><img src="images/pastry6.jpg" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    <h1 style="font-family: Lobster; " id="prodName">Tuna Pie</h3>
