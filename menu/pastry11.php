        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="images/pastry11.jpg" class="image-popup"><img src="images/pastry11.jpg" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    <h1 style="font-family: Lobster; " id="prodName">Red Velvet Cake</h3>
                        <p class="price" style="margin-top: -3%;"><span style=" font-size: 20px;">₱255.00</span></p>
