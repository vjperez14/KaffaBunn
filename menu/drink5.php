        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="images/drink5.jpg" class="image-popup"><img src="images/drink5.jpg" class="img-fluid"
                            alt="Colorlib Template"></a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    <h1 style="font-family: Lobster; " id="prodName">Hot Maple LAtte</h3>
                        <p class="price" style="margin-top: -3%;"><span style=" font-size: 20px;">₱185.00</span></p>
